...
azure_doc_ai_client = DocumentAnalysisClient(
...
async def analyze_document(request: AnalyzeRequest):
    """Endpoint to analyze document using specified prebuilt model
       \nmodel_name : prebuilt-read, prebuilt-layout, prebuilt-idDocument, prebuilt-invoice, prebuilt-receipt
      \n return format : plain_text, flat, structured (in header-item format).
    """
    try:
        poller = azure_doc_ai_client.begin_analyze_document_from_url(
